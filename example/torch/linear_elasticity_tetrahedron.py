...
# # (NQ, LDOF, BC)
# gphi_lambda_tet = space_tet.grad_basis(bcs, variable='u')
# print("gphi_lambda_tet:", gphi_lambda_tet.shape)
# # (NC, NQ, LDOF, GD)
# gphi_x_tet = space_tet.grad_basis(bcs, variable='x')
# print("gphi_x_tet:", gphi_x_tet.shape)
# #  phi-(1, NQ, ldof)
# phi_tet = space_tet.basis(bcs, variable='x')
...
# # tcell2dof-(NC, TLDOF)
# tcell2dof = tensor_space_tet_node.cell_to_dof()
# print("tcell2dof:", tcell2dof.shape, "\n", tcell2dof)
# # tphi-(1, NQ, TLDOF, GD)
# tphi = tensor_space_tet_node.basis(bcs, variable='x')
