...
from fealpy.fem.scalar_convection_integrator import ScalarConvectionIntegrator
...
bform1 = BilinearForm(space)
bform1.add_domain_integrator(ScalarMassIntegrator())
M = bform1.assembly()

bform2 = BilinearForm(space)
bform2.add_domain_integrator( ScalarConvectionIntegrator(c = u ) )
C = bform2.assembly()
