...
from fealpy.ml.modules import (
    RandomFeatureSpace, PoUSpace, Cos, PoUSin, Function, Tanh,
    Solution
)
...
def factory(i: int):
    if i in {5, 6, 9, 10}:
        ...
        sp = RandomFeatureSpace(2, Jn, Cos(), bound=(2.0, PI))
    return sp

space = PoUSpace(factory, centers=node, radius=1.0, pou=PoUSin())
