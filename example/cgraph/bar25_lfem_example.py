...
model25 = cgraph.create("Bar25Data")
mesher25 = cgraph.create("Bar25Mesh")
spacer = cgraph.create("FunctionSpace")
materialer25 = cgraph.create("Bar25Material")
bar25_model = cgraph.create("Bar25Model")
solver = cgraph.create("DirectSolver")
postprocess = cgraph.create("UDecoupling")
coord = cgraph.create("Rbar3d")
strain_stress = cgraph.create("Bar25StrainStress")

model25()
mesher25()
spacer(type="lagrange", mesh=mesher25(), p=1)
materialer25(property="structural-steel", type="bar", E=1500, nu=0.3)
