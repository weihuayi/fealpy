...
class DiffusionIntegrator(LinearInt, OpInt, CellInt):
    ...
    def assembly(self, space: _FS, /, indices=None) -> TensorLike:
        """
        Restriction: constant coefficient, simplex mesh
        TODO: add assert
        """
        mesh = space.mesh
    ...
    def assembly(self, space: _FS, /, indices=None) -> TensorLike:
        """
        Surface isoparametric finite element integrator assembly
        """
        index = self.entity_selection(indices)
