...
class FaceSourceIntegrator(LinearInt, SrcInt, FaceInt):
...
class InterfaceSourceIntegrator(FaceSourceIntegrator):
    @enable_cache
    def make_index(self, space: _FS):
        index = self.threshold
        return index

class BoundarySourceIntegrator(FaceSourceIntegrator):
    @enable_cache
    def make_index(self, space: _FS):
        index = self.threshold
        return index
