...
from ..fem import OPCIntegrator
from ..fem import OPCSIntegrator
...
class OPCRTFEMModel(ComputationalModel):
    ...
    def __init__(self, pde: Optional[OPCPDEDataT] = None):
        if pde is None:
    ...
    def linear_system(self):
        ...
        bform1.add_integrator(OPCIntegrator(coef=pde.diffusion_coef_inv, q=3))
