...
// 添加原子操作函数定义
// template <typename T>
// __device__ T gpuAtomicAdd(T* address, T val);

// template <>
// __device__ float gpuAtomicAdd<float>(float* address, float val) {
//   return atomicAdd(address, val);
// }

// template <>
// __device__ double gpuAtomicAdd<double>(double* address, double val) {
