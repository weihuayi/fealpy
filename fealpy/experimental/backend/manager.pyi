...
class BackendManager():
    ...
    def device_type(self, tensor_like: _DT, /) -> str: ...
    ...
    ### Other Functions ###
    def set_at(self, x: _DT, indices: _DT, src: _DT, /) -> _DT: ...
    def add_at(self, x: _DT, indices: _DT, src: _DT, /) -> _DT: ...
    def index_add(self, x: _DT, index: _DT, src: _DT, /, *, axis: int=0, alpha: Number=1) -> _DT: ...
