...
class BackendManager():
    ...
    # Numpy + PyTorch
    def empty_like(self, prototype: _DT, /, dtype=None, **kwargs) -> _DT: ...
    # Numpy + PyTorch
    def zeros_like(self, prototype: _DT, /, dtype=None, **kwargs) -> _DT: ...
    # Numpy + PyTorch
    def ones_like(self, prototype: _DT, /, dtype=None, **kwargs) -> _DT: ...
    # Numpy
    ...
    # Numpy + PyTorch
    def einsum(self, subscripts: str, /, *operands: _DT, optimize=False, **kwargs) -> _DT: ...
    # Numpy
    ...
    def edge_normal(self, edge: _DT, node: _DT, normalize=False, *, out=None) -> _DT: ...
    def edge_tengent(self, edge: _DT, node: _DT, normalize=False, *, out=None) -> _DT: ...
