...
class DLDMicrofluidicChipModeler3D:
    """
    A class for geometric modeling of microfluidic 3D chips with deterministic lateral displacement (DLD) arrays.
    ...
    Examples:
        >>> modeler = DLDMicrofluidicChipModeler3D()
    ...
    def __init__(self, options: Optional[Dict[str, Any]] = None) -> None:
        """
        Initialize the DLD microfluidic 3D chip modeler with given or default options.
