...
class ScalerPenaltyBoundarySourceIntegrator():
    ...
    def assembly_face_vector(self, space: ScaledMonomialSpace, out=None):
        ...
        fh = mesh.entity_measure('face', index=bd_face_flag)
        ...
        A = np.einsum('q, qf, qfj, f -> fj', ws, gval, phi, 1/fh,  optimize=True) # (NQ, ldof)
