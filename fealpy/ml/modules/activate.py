...
class Activation(Module):
    ...
    def dn(self, x: Tensor, order: int) -> Tensor:
        """order-specified derivative of activation function at x."""
        if order == 0:
    ...
    def d1(self, p: Tensor) -> Tensor:
        """1-order derivative of activation function at p."""
        raise NotImplementedError

    def d2(self, p: Tensor) -> Tensor:
        """2-order derivative of activation function at p."""
        raise NotImplementedError

    def d3(self, p: Tensor) -> Tensor:
        """3-order derivative of activation function at p."""
        raise NotImplementedError

    def d4(self, p: Tensor) -> Tensor:
        """4-order derivative of activation function at p."""
        raise NotImplementedError
