...
from fealpy.jax.sph.jax_md import dataclasses, space, util
...
def unflatten_cell_buffer(arr: Array, cells_per_side: Array, dim: int) -> Array:
    if (
        isinstance(cells_per_side, (int, float))
        or util.is_array(cells_per_side)
        and not cells_per_side.shape
    ):
