...
class NonlinearPDEDataProtocol(Protocol):                                        
    """Protocol interface for nonlinear PDE data components.                        
                                                                                   
    Defines the recommended protocol interface for nonlinear partial differential equation solvers.
...
NonlinearPDEDataT = TypeVar('NonlinearPDEDataT', bound=NonlinearPDEDataProtocol)   
