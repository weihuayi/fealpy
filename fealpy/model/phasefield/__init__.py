...
class PhaseFieldPDEDataProtocol(Protocol):
...
ParabolicPDEDataT = TypeVar('ParabolicPDEDataT', bound=PhaseFieldPDEDataProtocol)
...
DATA_TABLE = {
    ...
    "ac_circle": ("ac_circle_data_2d", "AcCircleData2D"),
