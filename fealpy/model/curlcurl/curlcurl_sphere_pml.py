...
class CurlCurlSpherePML():
    def __init__(self, r0 : float, r1 : float, omega : float, mu : float,
                       epsilon : float, s : float = 5.0, p : int = 2, TD = 3, device = None):
        """
