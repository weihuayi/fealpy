...
class NSFVMSolver:
    def __init__(self, pde, ht):
        ...
        self.EN_u = list(set(cell2edge[:, 3]) | set(cell2edge[:, 1]))
        self.EN_v = list(set(cell2edge[:, 0]) | set(cell2edge[:, 2]))
    ...
    def NS_Lform_us(self):
        ...
        A_us = coo_matrix((val,(I, J)), shape=(NC0, NC0))
    ...
    def NS_Lform_vs(self):
        ...
        A_vs = coo_matrix((val,(I, J)), shape=(NC1, NC1))
    ...
    def NS_Bform_us(self, u0, v0, p0):
        ...
        #Q_C += self.mesh0.integral(self.pde.source_u, celltype=True)
        b_u0 += b_uC + b_uF + Q_uC
    ...
    def NS_Bform_vs(self, u0, v0, p0):
        ...
        #Q_C += self.mesh1.integral(self.pde.source_v, celltype=True)
        b_v0 += b_vC + b_vF + Q_vC
    ...
    def DirichletBC_1(self, u0, v0, p0):
        ...
        b_u0 += data0
        b_u0[flag0[..., 1]] = u_nC0[flag0[..., 1]]
        b_u0[flag0[..., 3]] = u_nC0[flag0[..., 3]]

        b_v0 = self.NS_Bform_vs(u0, v0, p0) 
        bv = bm.zeros(self.NC1)
        bvnode0 = point_node[c2n1[..., 0][flag1[..., 3]]]
        bvnode1 = node[np.isclose(node[:, 0], 1.0)]
        ...
        b_v0 += data1
        b_v0[flag1[..., 0]] = v_nC0[flag1[..., 0]]
        b_v0[flag1[..., 2]] = v_nC0[flag1[..., 2]]
    ...
    def NS_Lform_p(self):
        ...
        A_p = coo_matrix((val,(I, J)), shape=(NC, NC))
    ...
    def NS_Lform_u1(self):
        ...
        J = bm.arange(NC0)
        val = bm.ones(NC0)
        A_u1 = coo_matrix((val,(I, J)), shape=(NC0, NC0))
    ...
    def NS_Lform_v1(self):
        ...
        J = bm.arange(NC1)
        val = bm.ones(NC1)
        A_v1 = coo_matrix((val,(I, J)), shape=(NC1, NC1))
