...
class slip_stick:
    ...
    def moving_mesh(self):
        self.box = [0, 1, 0, 0.15]
        mesh = TriangleMesh.from_box_cross_mesh(self.box, nx=int(1/(1.5*self.h)), ny=int(0.2/self.h))
        mesh.meshdata['vertices'] = bm.array([[0,0],[1,0],[1,0.15],[0,0.15]],dtype = bm.float64)
        return mesh
