...
eta = 0.1 * H
rhomin = 995
box_size = bm.array([1.6, 0.61, 0.6], dtype=bm.float64)
maxstep = 4000
path = "./"

mesh = NodeMesh.from_dam_break_domain_3d(dx, dy, dz)
...
tag = mesh.nodedata["tag"]
fluid_mask = (mesh.nodedata["tag"] == 0)
for i in range(maxstep):
    ...
    mesh.nodedata["mass"] = mesh.nodedata["rho"] * dx * dy * dz
