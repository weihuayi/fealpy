...
class Exp0001(BoxMesher2d):
    ...
    def source(self, p: TensorLike) -> TensorLike:
        ...
        sin = bm.sin
        cos = bm.cos
        result[..., 0] = -10000.0*x**2*y**2*(1 - x)**4 - 12000.0*x**2*y**2*(1 - x)**2*(1 - y)*(3 - 5*y) + 20000.0*x**2*y*(1 - x)**4*(1 - y) + 4000.0*x**2*y*(1 - x)**4*(3 - 5*y) - 2000.0*x**2*(1 - x)**4*(1 - y)*(3 - 5*y) + 16000.0*x*y**2*(1 - x)**3*(1 - y)*(3 - 5*y) - 2000.0*y**2*(1 - x)**4*(1 - y)*(3 - 5*y) + pi**2*(-4*pi*x**2*y**4*sin(2*pi*x**2*y) - 2*pi*x**2*y**2*cos(2*pi*x*y) - 2*x*y*sin(2*pi*x*y) + y**3*cos(2*pi*x**2*y))
        result[..., 1] = 4000.0*x*y**3*(1 - 3*x)*(1 - x)**3 - 6000.0*x*y**3*(1 - 3*x)*(1 - y)**2*(2*x - 2) + 36000.0*x*y**3*(1 - x)**2*(1 - y)**2 + 12000.0*x*y**2*(1 - 3*x)*(1 - x)**3*(2*y - 2) + 12000.0*x*y*(1 - 3*x)*(1 - x)**3*(1 - y)**2 - 12000.0*y**3*(1 - 3*x)*(1 - x)**2*(1 - y)**2 - 12000.0*y**3*(1 - x)**3*(1 - y)**2 + pi**2*(-2*pi*x**3*y**3*sin(2*pi*x**2*y) - 2*pi*x**3*y*cos(2*pi*x*y) - x**2*sin(2*pi*x*y) + 3*x*y**2*cos(2*pi*x**2*y))
        return result
