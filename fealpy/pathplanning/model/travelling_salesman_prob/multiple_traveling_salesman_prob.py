...
class MultipleTravelingSalesmanProb(TravellingSalesmanProb):
    ...
    def __init__(self, options):
        ...
        pos = bm.concatenate([pos, warehouse])
        ...
        self.down_alg = options['down_opt_dict']['opt_alg']
        self.down_N = options['down_opt_dict']['NP']
        self.down_T = options['down_opt_dict']['MaxIT']
    ...
    def opt_paths(self):
        ...
        for i in range(self.up_N):
            ...
            for j in range(self.uav_num):
                fobj = lambda x: super().cost_function(x, self.D_arrays[i][j])
