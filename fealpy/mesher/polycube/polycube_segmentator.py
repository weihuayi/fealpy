...
class PolyCubeSegmentator:
    ...
    def segmentation(self,
        ...
        """
        self.build_candidate_charts()
        self.extract_candidate_edges_vertices()
        self.straighten_edges(max_iter=straighten_max_iter)
        self.merge_small_charts(min_size=merge_min_size)
        is_valid = self.validate_topology()
        self.laplacian_smooth(alpha=laplacian_smooth_alpha, max_iter=laplacian_smooth_max_iter)
...
if __name__ == '__main__':
    ...
    processor = PolyCubeSegmentator(volume_mesh)
    ...
    bd_mesh_project.to_vtk(fname='./data/bd_mesh_project.vtu')
